...
const SECTIONS = [
  {
    ...
    body: [
      "Cleana+ משתמשת אך ורק בעוגיות הכרחיות — הנדרשות להתחברות ולאימות של המטפל (שמירת מצב ההתחברות בין דפים, ומזהי session המנוהלים על ידי ספק האימות Clerk). עוגיות אלה חיוניות לתפקוד הבסיסי של השירות ולא ניתן לכבות אותן.",
  ...
  },
  {
    ...
    body: [
      "ניתן לחסום או למחוק עוגיות דרך הגדרות הדפדפן. חסימת העוגיות ההכרחיות תמנע התחברות לחשבון המטפל, אך לא תשפיע על יכולת הלקוחות להזמין תור.",
    ],
  },
];
