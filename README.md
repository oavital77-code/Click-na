...
**שינוי מנוי** (`src/lib/subscriptions.ts`) בנוי ונבדק, אבל שום דבר במוצר לא קורא לו עדיין — אין מסלול תשלום. זה התפר שאליו ספק סליקה מתחבר, וההתחברות היא קריאה אחת.
